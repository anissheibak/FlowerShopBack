...
use App\Http\Controllers\Admin\Market\StoreHouseController;
...
Route::prefix('admin')->namespace('Admin')->group(function(){
    ...
    Route::prefix('market')->namespace('Market')->group(function(){
        ...
        Route::prefix('category')->group(function(){
            ...
            Route::get('/update/{id}', [CategoryController::class, 'update'])->name('admin.market.category.upadate');
            Route::post('/edit/{id}', [CategoryController::class, 'edit'])->name('admin.market.category.edit');
        ...
        Route::prefix('store')->group(function(){
            ...
            Route::get('/update/{id}', [StoreController::class, 'update'])->name('admin.market.store.upadate');
            Route::post('/edit/{id}', [StoreController::class, 'edit'])->name('admin.market.store.edit');
        ...
        Route::prefix('comment')->group(function(){
            ...
            Route::get('/update/{id}', [CommentController::class, 'update'])->name('admin.market.comment.upadate');
            Route::post('/edit/{id}', [CommentController::class, 'edit'])->name('admin.market.comment.edit');
        ...
        Route::prefix('delivery')->group(function(){
            ...
            Route::get('/update/{id}', [DeliveryController::class, 'update'])->name('admin.market.delivery.upadate');
            Route::post('/edit/{id}', [DeliveryController::class, 'edit'])->name('admin.market.delivery.edit');
        ...
        Route::prefix('product')->group(function(){
            ...
            Route::get('/store', [ProductController::class, 'store'])->name('admin.market.product.store');
            Route::get('/edit/{id}', [ProductController::class, 'edit'])->name('admin.market.product.edit');
            Route::get('/update/{id}', [ProductController::class, 'update'])->name('admin.market.product.update');
            Route::delete('/destroy/{id}', [ProductController::class, 'destroy'])->name('admin.market.product.destroy');

            //gallery
            Route::get('/gallery', [GalleryController::class, 'index'])->name('admin.market.gallery.show');
            Route::get('/gallery/store', [GalleryController::class, 'store'])->name('admin.market.gallery.store');
            Route::delete('/gallery/destroy/{id}', [GalleryController::class, 'changeOrderStatus'])->name('admin.market.gallery.destroy');
        });
        ...
        Route::prefix('property')->group(function(){
            ...
            Route::get('/update/{id}', [PropertyController::class, 'update'])->name('admin.market.property.upadate');
            Route::post('/edit/{id}', [PropertyController::class, 'edit'])->name('admin.market.property.edit');
        ...
        Route::prefix('storehouse')->group(function(){
            Route::get('/', [StoreHouseController::class, 'index'])->name('admin.market.storehouse.index');
            Route::get('/add-to-storehouse', [StoreHouseController::class, 'addToStorehouse'])->name('admin.market.storehouse.add-to-storehouse');
            Route::post('/store', [StoreHouseController::class, 'store'])->name('admin.market.storehouse.store');
            Route::get('/update/{id}', [StoreHouseController::class, 'update'])->name('admin.market.storehouse.upadate');
            Route::post('/edit/{id}', [StoreHouseController::class, 'edit'])->name('admin.market.storehouse.edit');
            Route::delete('/destroy/{id}', [StoreHouseController::class, 'destroy'])->name('admin.market.storehouse.destroy');
        });
    ...
    Route::prefix('content')->namespace('Content')->group(function(){
        ...
        Route::get('/update/{id}', [ContentCategoryController::class, 'update'])->name('admin.content.category.upadate');
        Route::post('/edit/{id}', [ContentCategoryController::class, 'edit'])->name('admin.content.category.edit');
    ...
    Route::prefix('comment')->group(function(){
        ...
        Route::get('/update/{id}', [ContentCommentController::class, 'update'])->name('admin.content.comment.upadate');
        Route::post('/edit/{id}', [ContentCommentController::class, 'edit'])->name('admin.content.comment.edit');
    ...
    Route::prefix('faq')->group(function(){
        ...
        Route::get('/update/{id}', [FAQController::class, 'update'])->name('admin.content.faq.upadate');
        Route::post('/edit/{id}', [FAQController::class, 'edit'])->name('admin.content.faq.edit');
    ...
    Route::prefix('menu')->group(function(){
        ...
        Route::get('/update/{id}', [MenuController::class, 'update'])->name('admin.content.menu.upadate');
        Route::post('/edit/{id}', [MenuController::class, 'edit'])->name('admin.content.menu.edit');
    ...
    Route::prefix('page')->group(function(){
        ...
        Route::get('/update/{id}', [PageController::class, 'update'])->name('admin.content.page.upadate');
        Route::post('/edit/{id}', [PageController::class, 'edit'])->name('admin.content.page.edit');
    ...
    Route::prefix('post')->group(function(){
        ...
        Route::get('/update/{id}', [PostController::class, 'update'])->name('admin.content.post.upadate');
        Route::post('/edit/{id}', [PostController::class, 'edit'])->name('admin.content.post.edit');
    ...
    Route::prefix('user')->namespace('User')->group(function(){
        ...
        Route::prefix('admin-user')->group(function(){
            ...
            Route::get('/update/{id}', [ AdminUserController::class, 'update'])->name('admin.user.admin-user.upadate');
            Route::post('/edit/{id}', [ AdminUserController::class, 'edit'])->name('admin.user.admin-user.edit');
        ...
        Route::prefix('customer')->group(function(){
            ...
            Route::get('/update/{id}', [CustomerController::class, 'update'])->name('admin.user.customer.upadate');
            Route::post('/edit/{id}', [CustomerController::class, 'edit'])->name('admin.user.customer.edit');
        ...
        Route::prefix('role')->group(function(){
            ...
            Route::get('/update/{id}', [RoleController::class, 'update'])->name('admin.user.role.upadate');
            Route::post('/edit/{id}', [RoleController::class, 'edit'])->name('admin.user.role.edit');
        ...
        Route::prefix('permission')->group(function(){
            ...
            Route::get('/update/{id}', [PermissionController::class, 'update'])->name('admin.user.permission.upadate');
            Route::post('/edit/{id}', [PermissionController::class, 'edit'])->name('admin.user.permission.edit');
    ...
    Route::prefix('notify')->namespace('Notify')->group(function(){
        ...
        Route::prefix('email')->group(function(){
            ...
            Route::get('/update/{id}', [EmailController::class, 'update'])->name('admin.notify.email.upadate');
            Route::post('/edit/{id}', [EmailController::class, 'edit'])->name('admin.notify.email.edit');
        ...
        Route::prefix('sms')->group(function(){
            ...
            Route::get('/update/{id}', [SMSController::class, 'update'])->name('admin.notify.sms.upadate');
            Route::post('/edit/{id}', [SMSController::class, 'edit'])->name('admin.notify.sms.edit');
    ...
    Route::prefix('ticket')->namespace('Ticket')->group(function(){
            ...
            Route::post('/close-tickets', [TicketController::class, 'closeTickets'])->name('admin.ticket.closeTickets');
            ...
            Route::get('/update/{id}', [TicketController::class, 'update'])->name('admin.ticket.upadate');
            Route::post('/edit/{id}', [TicketController::class, 'edit'])->name('admin.ticket.edit');
    ...
    Route::prefix('setting')->namespace('Setting')->group(function(){
            ...
            Route::get('/update/{id}', [SettingController::class, 'update'])->name('admin.setting.upadate');
            Route::post('/edit/{id}', [SettingController::class, 'edit'])->name('admin.setting.edit');
